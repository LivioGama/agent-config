...
Cross-platform handler that processes `agent-rules://` deeplinks to download and install agent rules or skills automatically. Supports macOS, Linux, and Windows.
...
This builds the app to `$HOME/Applications/AgentRulesHandler.app` and registers the URL scheme.
